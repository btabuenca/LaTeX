...
\begin{figure}
     \includegraphics[width=1\linewidth]{img/Esm_fig1}
...
\begin{figure}
     \includegraphics[width=1\linewidth]{img/Esm_fig2}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:2}
\end{figure}
...
\begin{figure}
     \includegraphics[width=1\linewidth]{img/Esm_fig3}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:3}
\end{figure}
...
\begin{figure}
     \includegraphics[width=1\linewidth]{img/Esm_fig4}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:4}
\end{figure}
\subsection{Results}
...
\begin{figure}
     \includegraphics[width=1\linewidth]{img/Esm_fig5}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:5}
\end{figure}
...
\begin{figure}
     \includegraphics[width=1\linewidth]{img/Esm_fig6}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:6}
\end{figure}
