...
Tabuenca, B., Kalz, M., Drachsler, H., \& Specht, M. (2015). (Submitted) Time Will Tell: The role of mobile learning analytics in self-regulated learning. \em Computers \& Education \em
...
\begin{tabular}[c]{@{}c@{}}1 click to \\ check-out\end{tabular}       & \begin{tabular}[c]{@{}c@{}}2 scroll bottom\\ MM\end{tabular}                               & \begin{tabular}[c]{@{}c@{}}1 click on\\ ÒdoneÓ\end{tabular}                             & \begin{tabular}[c]{@{}c@{}}2 clicks to \\ scroll and select\\ bottom HH\end{tabular}       \\
                                                                      & \begin{tabular}[c]{@{}c@{}}1 click fast-fwd \\ asynch. log\end{tabular}                    & \begin{tabular}[c]{@{}c@{}}1 click to display \\ MM scroll \\ 1st activity\end{tabular} & 1 click on ÒdoneÓ                                                                          \\
                                                                      &                                                                                            & \begin{tabular}[c]{@{}c@{}}1 clicks to\\ select MM\end{tabular}                         & \begin{tabular}[c]{@{}c@{}}1 click to display \\ MM scroll\end{tabular}                    \\
                                                                      &                                                                                            & 1 click on ÒdoneÓ                                                                       & \begin{tabular}[c]{@{}c@{}}2 clicks to scroll \\ and select\\ bottom MM\end{tabular}       \\
                                                                      &                                                                                            & 1 click on ÒsendÓ                                                                       & 1 click on ÒdoneÓ                                                                          \\
                                                                      &                                                                                            &                                                                                         & 1 click on ÒsendÓ                                                                          \\
\hline                                                                      
...
This manuscript has explored the use of mobile time-logs to foster self-regulation in online learning environments. Learning analytics delivered to students via mobile chart-visualizations and notifications have been used to support them in the competence development of Òlearning to learnÓ \citep{EuropeanCommission2007} by raising awareness on \em time management \em as trigger to foster understanding on meta-learning \citep{Tabuenca2014,Biggs1985}. The analysis of the results concludes in the following findings:
\begin{itemize}
...
Weekly patterns. Thursdays (18.56\%) and Sundays (18.25\%) were the days with more activity in contrast to Mondays (10.56\%) and Fridays (10.69\%) balancing the over-performance from the previous day in a Òrebound effectÓ. 
