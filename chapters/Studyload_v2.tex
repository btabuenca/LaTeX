...
\begin{itemize}
\item Hypothesis 2: The intermediate measure M2 is significantly higher in contrast to the final measure M3.
\end{itemize}
...
The contrasts do not confirm significant differences from the intermediate measure M2 to the final measure M3. Figure \ref{fig:sload_9a} shows that the mean for M2 (2.15) represents slightly higher scores for TM than the mean for M3 (2.20), whereas figure \ref{fig:sload_9b} shows that the mean for M3 (2.26) represents slightly higher scores for TP than the mean for M2 (2.38). Nevertheless, none of these differences are significant and consequently the hypothesis cannot be confirmed.
...
\begin{itemize}
\item Hypothesis 3: The intermediate measure M2 has significant higher score than the intermediate measure M1.
\end{itemize}
...
The contrasts do not confirm significant differences between the intermediate measures M1 and M2. Figure \ref{fig:sload_7a} shows that the mean for M2 (2.15) represents slightly higher scores for TM than the mean for M1 (2.22), whereas figure \ref{fig:sload_7b} shows that the mean for M2 (2.38) represents slightly higher scores for TP than the mean for M1 (2.41). Nevertheless, none of these differences are significant and consequently the hypothesis cannot be confirmed.
