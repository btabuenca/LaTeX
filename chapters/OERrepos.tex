...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig1}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig2}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:2}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig3}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:3}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig4}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:4}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig5}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:5}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig6}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:6}
\end{figure}
