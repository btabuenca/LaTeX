...
\begin{figure}
     \centering
     \includegraphics[width=0.5\linewidth]{img/oerrepos_fig8}
     \caption{Question 2: \em Did you consider providing an app to access the contents in your repository?\em. Percentage for n=23 repositories.}
     \label{fig:8}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.5\linewidth]{img/oerrepos_fig9}
     \caption{Question 3: \em Do you know any suitable app for accessing content repositories or open content?\em. Percentage for n=23 repositories.}
     \label{fig:9}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.5\linewidth]{img/oerrepos_fig10}
     \caption{Question 4: \em Do you think an app could increase the access rates to your repository?\em. Percentage for n=23 repositories.}
     \label{fig:10}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.5\linewidth]{img/oerrepos_fig11}
     \caption{Question 5: \em Would you consider providing an application interface (API) for accessing to your repository from other sites and apps?\em. Percentage for n=23 repositories.}
     \label{fig:11}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig12}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig13}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig14}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:14}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig16}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:16}
\end{figure}
...
\begin{figure}
     \centering
     \includegraphics[width=0.9\linewidth]{img/oerrepos_fig17}
     \caption{Catpioooooooooooooonnnnnnnnnn}
     \label{fig:17}
\end{figure}
