...
\item Bluetooth Low Energy (BLE) beacons (figure  \ref{fig:nfceco_1}. See green hexagon). BLE-beacons are being novelty used to provide proximity-adapted feedback in the field of shop-ping , access control, and home entertainment. Hereby, we use BLE-beacons to monitor student’s progress when he approaches or moves away from the beacon (e.g. desktop at home; office at workplace).
\end{itemize}
